...
const TEXT = {
  en: {
    ...
    panelText: 'Use the first row as headers, preserve Unicode, and download structured JSON without sending data to a server.',
    ...
    trustTitle: 'Private by design', trustOne: '<b>Local conversion.</b> CSV parsing and JSON generation run in your browser.', trustTwo: '<b>No uploads.</b> Files opened here stay on your device.',
    ...
    privacyTitle: 'Privacy Policy', privacy: 'We do not collect, store, upload, or transmit CSV or JSON data. Local file selection reads the file only in your browser.',
