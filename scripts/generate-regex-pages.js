...
const TEXT = {
  en: { title: 'Regex Tester - Test JavaScript Regular Expressions Online | ConvertUnlimited', description: 'Test JavaScript regex patterns locally in your browser. Highlight matches, flags, capture groups, replace preview, and Unicode support.', hero: 'Regex Tester', sub: 'Test JavaScript regular expressions locally for validation, parsing, and debugging workflows.', eyebrow: 'Local developer validation tool', panelTitle: 'Test regex patterns safely.', panelText: 'Enter a pattern and sample text to highlight matches, preview replacements, and inspect capture groups with selected inputs processed locally in your browser.', pattern: 'Regex pattern', flags: 'Flags', text: 'Test text', replace: 'Replace with', output: 'Highlighted matches', results: 'Match results', preview: 'Replace preview', sample: 'Sample regex', clear: 'Clear', trustTitle: 'Private by design', trustOne: '<b>Local testing.</b> Regex matching runs in your browser.', trustTwo: '<b>Local processing.</b> Patterns and text are processed locally in your browser.', articleTitle: 'When should you test regex?', articleP1: 'Regex testing helps validate form input, parse logs, inspect API text, and debug extraction rules before using them in code.', articleP2: 'This tool uses native JavaScript RegExp behavior and renders user text as text, not HTML.', faqTitle: 'Frequently Asked Questions', faq: [['Is this Regex Tester free?', 'Yes. You can test patterns and preview replacements without signup.'], ['Is my text sent to ConvertUnlimited servers?', 'No server-side upload endpoint is used for testing; patterns and text are processed locally in your browser.'], ['Which regex engine is used?', 'It uses the native JavaScript RegExp engine in your browser.'], ['Are invalid regex patterns handled?', 'Yes. The tool shows a friendly warning and preserves your input.'], ['Does it support Unicode regex?', 'Yes. Use the u flag for Unicode-aware patterns.']], privacyTitle: 'Privacy Policy', privacy: 'ConvertUnlimited does not provide a server-side upload endpoint for this regex testing flow. Patterns and test text are processed locally in your browser.', termsTitle: 'Terms of Use', terms: 'ConvertUnlimited is provided as is. Test expressions carefully before using them in production systems.' },
