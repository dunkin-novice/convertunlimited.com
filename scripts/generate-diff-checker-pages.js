...
const TEXT = {
  en: { title: 'Diff Checker - Compare Text Online | ConvertUnlimited', description: 'Compare two texts locally in your browser. Show added, removed, and unchanged lines with summary counts, copy diff output, and no uploads.', hero: 'Diff Checker', sub: 'Compare two texts locally and see added, removed, and unchanged lines.', eyebrow: 'Local developer comparison tool', panelTitle: 'Compare original and changed text.', panelText: 'Paste two versions, run a line-based diff, and copy the result without sending text to a server.', left: 'Original text', right: 'Changed text', ignoreCase: 'Ignore case', ignoreWhitespace: 'Ignore whitespace', compare: 'Compare text', sample: 'Sample diff', clear: 'Clear', output: 'Diff output', copy: 'Copy diff', summary: 'Summary', trustTitle: 'Private by design', trustOne: '<b>Local comparison.</b> Text comparison runs in your browser.', trustTwo: '<b>No uploads.</b> Text stays on your device.', articleTitle: 'When should you use a diff checker?', articleP1: 'Diff checking helps review edits, compare snippets, inspect configuration changes, and debug text output before sharing or deploying.', articleP2: 'This tool uses a simple line-based comparison and renders text safely as text, not raw HTML.', faqTitle: 'Frequently Asked Questions', faq: [['Is this Diff Checker free?', 'Yes. You can compare, copy, and clear text without signup.'], ['Is my text uploaded?', 'No. Comparison happens locally in your browser.'], ['What kind of diff is used?', 'The tool uses a line-based diff that marks added, removed, and unchanged lines.'], ['Can it ignore whitespace or case?', 'Yes. Use the toggles before comparing.'], ['Does it support Unicode?', 'Yes. Unicode text and emojis are handled as browser strings.']], privacyTitle: 'Privacy Policy', privacy: 'We do not collect, store, upload, or transmit text entered into this tool.', termsTitle: 'Terms of Use', terms: 'ConvertUnlimited is provided as is. Review diff output before using it in production workflows.' },
